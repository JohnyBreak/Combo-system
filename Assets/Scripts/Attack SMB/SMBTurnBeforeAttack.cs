...
public class SMBTurnBeforeAttack : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (_playerInput.MoveDirection != Vector3.zero)
        {
            Quaternion toRotate = Quaternion.LookRotation(_playerInput.MoveDirection.normalized, animator.transform.root.up);
